...
def train_model():
    ...
    print(f"Starting experiment with context_length={config.context_length}")
    ...
    run_name = f"context_length-{config.context_length}"
    ...
    print(f"Training complete for context_length-{config.context_length}")
    return trainer
